...
const AuthenticatedApp = () => {
  ...
  // Handle authentication errors - if auth_required, user will be redirected by navigateToLogin
  if (authError) {
    if (authError.type === 'user_not_registered') {
      return <UserNotRegisteredError />;
    } else if (authError.type === 'auth_required') {
      // Will trigger redirect to login
      navigateToLogin();
      return null;
    }
  }

  // If not authenticated and no auth_required error, still redirect to login
